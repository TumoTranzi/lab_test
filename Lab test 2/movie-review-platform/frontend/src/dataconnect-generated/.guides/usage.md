...
```ts
import { useCreateNewList, useGetPublicLists, useAddMovieToList, useDeleteList } from '@dataconnect/generated/react';
...
const { data, isPending, isSuccess, isError, error } = useDeleteList(deleteListVars);
